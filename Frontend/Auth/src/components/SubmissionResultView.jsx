...
const SubmissionResultView = ({ submissionResult, onClose }) => {
  ...
  const { accepted, totalTestCases, passedTestCases, runtime, memory } = submissionResult;
  ...
  const strokeDashoffset = circumference - (animatedPassedCases / totalTestCases) * circumference;

  return (
    <div className="w-full flex flex-col flex-grow p-6 bg-base-100">
      {/* Header */}
      ...
      <div className="flex-grow flex flex-col items-center justify-center py-6">
        <div className="relative w-32 h-32">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            {showStatusIcon ? (
              isSuccess ? (
                <svg className={`w-12 h-12 ${statusColorClass}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="mt-auto pt-6 border-t border-base-300">
        <div className="grid grid-cols-2 gap-4 text-sm mb-6">
          <div className="flex justify-center items-center p-4 rounded-lg bg-base-200">
            <div className="text-center">
              <span className="block text-sm text-base-content/60">Runtime</span>
        ...
        <div className="flex justify-center items-center p-4 rounded-lg bg-base-200">
          <div className="text-center">
            <span className="block text-sm text-base-content/60">Test Cases Passed</span>
            <strong className="font-medium text-base-content">
